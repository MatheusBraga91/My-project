...
public class AIPanelController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            leftArrowButton.onClick.AddListener(() => NavigateAICharacter(-1)); // Left button: navigate backwards
            rightArrowButton.onClick.AddListener(() => NavigateAICharacter(1)); // Right button: navigate forwards
        }
        else
        {
